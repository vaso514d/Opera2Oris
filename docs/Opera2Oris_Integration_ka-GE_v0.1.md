...
| `DefaultVatAccount` | `Charge` / `Package` related VAT row-ზე, როცა VAT row-ის CSV account ცარიელია | VAT credit/debit entry |
...
- VAT entry account აირჩევა VAT child row-ის CSV account-იდან, შემდეგ `DefaultVatAccount`, როცა related VAT row არსებობს.
...
- `DefaultVatAccount` - VAT fallback account. საჭიროა, როცა related VAT row-ს CSV account არ აქვს.
